...
<head>
    ...
    <!-- Gallery -->
    <link rel="canonical" href="https://riverternlodgebhadra.com/gallery.php">
        ...
        <section class=" hero sub-page-hero">
            ...
            <div class="bg-content container">
                <div class="hero-page-title">
                    <span class="hero-sub-title">Get to see the scene</span>
                ...
                <div class="card border-0 shadow-sm p-xl-2 mb-4 aos-init aos-animate" data-aos="fade">
                    <div class="card-body">
                        <div class="border-bottom mb-4 pb-4">
                            <h2 class="text-body-emphasis mb-0">Explore the Beauty of River Tern Lodge</h2>
                        </div>
                        <div class="d-lg-flex border-bottom pb-3 mb-4">
                            <div class="mnw-200 guest-icon">

                                <i class="hicon hicon-bold hicon-camera-hover"></i>


                            </div>
                            <p>Discover the beauty of River Tern Lodge through our gallery, showcasing serene
                                landscapes, diverse wildlife, and thrilling adventures by the stunning Bhadra Reservoir
                                in Karnataka's Western Ghats.
                            </p>
                            ...
                            <div class="col-12">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <a href="assets/img/destinations/hello-4.webp" class="glightbox"
