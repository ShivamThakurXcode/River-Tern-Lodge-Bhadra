...
var UseBootstrapSelect = (function () {
  ...
  var Fe = Object.defineProperty,
    qe = (e, t, s) =>
      t in e
        ? Fe(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s })
        : (e[t] = s),
        ...
        e.observers &&
          ...
          Y(() => {
            for (let i = 0; i < e.observers.length; i += 1) {
              ...
              c && ue.disposed.has(r),
                (c ? !r.tState : !r.state) &&
                  (r.pure ? A.push(r) : O.push(r), r.observers && Se(r)),
                c || (r.state = B);
            }
  ...
  function Xe(e, t, s) {
    ...
    try {
      ...
      return (
        e.pure &&
          ((e.state = B), e.owned && e.owned.forEach(re), (e.owned = null)),
        (e.updatedAt = s + 1),
        Ae(c)
      );
    } finally {
  ...
  function fe(e, t, s, n = B, i) {
    ...
    return (
      y === null || (y !== be && (y.owned ? y.owned.push(r) : (y.owned = [r]))),
      r
    );
  }
  function le(e) {
  ...
  function Se(e) {
    for (let t = 0; t < e.observers.length; t += 1) {
      ...
      s.state ||
        ((s.state = te), s.pure ? A.push(s) : O.push(s), s.observers && Se(s));
    }
  }
  function re(e) {
    let t;
    if (e.sources)
      for (; e.sources.length; ) {
        ...
        if (i && i.length) {
          ...
          n < i.length &&
            ((r.sourceSlots[c] = n), (i[n] = r), (s.observerSlots[n] = c));
        }
      }
    if (e.owned) {
          ...
          F(() => {
            ...
            if (w === 0)
              ...
              for (
                ...
                (L[C] = i[S]), (Q[C] = r[S]), l && (V[C] = l[S]);
              for (_ = new Map(), N = new Array(C + 1), u = C; u >= I; u--)
                (P = g[u]),
                  (h = _.get(P)),
                  (N[u] = h === void 0 ? -1 : h),
                  _.set(P, u);
      ...
      if (i === c) {
        ...
        if (u != null)
          if (l < u && u < r) {
            ...
            for (
              ;
              ++E < i && E < r && !((_ = h.get(t[E])) == null || _ !== u + w);
  ...
  function nt(e, t, s, n = {}) {
    ...
    return (
      ne((r) => {
        (i = r),
          t === document ? e() : $(t, e(), t.firstChild ? null : void 0, s);
      }, n.owner),
      () => {
        i(), (t.textContent = "");
      }
  ...
  function it(e) {
    ...
    for (
      ...
      if (n && !s.disabled) {
        const i = s[`${t}Data`];
        if ((i !== void 0 ? n.call(s, i, e) : n.call(s, e), e.cancelBubble))
          return;
      }
  ...
  function oe(e, t, s, n, i) {
    ...
    if (
      ...
      if (Array.isArray(t)) {
        const l = [],
          g = s && Array.isArray(s);
        if (he(l, t, s, i)) return T(() => (s = oe(e, l, s, n, !0))), () => s;
        if (l.length === 0) {
      ...
      if (!(l == null || l === !0 || l === !1))
        if ((h = typeof l) == "object" && l.nodeType) e.push(l);
          ...
          if (n) {
            for (; typeof l == "function"; ) l = l();
            i =
              he(e, Array.isArray(l) ? l : [l], Array.isArray(g) ? g : [g]) ||
              i;
          } else e.push(l), (i = !0);
        else {
          const u = String(l);
  ...
  const X = "use-bootstrap-select",
    ...
    Pe = class R {
      ...
      setValue(t) {
        const s = ge(t);
        this.selectElement.multiple || s.splice(1), this.setSelected(s, !0);
      }
      addValue(t) {
        const s = ge(t);
      ...
      addOption(t, s, n = !1, i = "first") {
        const r = s ?? t;
        if (
          !Array.from(this.selectElement.options).some((l) => l.value === t)
        ) {
      ...
      getItems() {
        return K(Array.from(this.selectElement.options)).map((t) => {
          ...
          return {
            ...
            disabled: t.disabled,
            label:
              ((s = t.parentElement) == null ? void 0 : s.tagName) ===
              "OPTGROUP"
      ...
      getSelected() {
        return Array.from(this.selectElement.selectedOptions).map((t) => ({
          value: t.value,
          text: t.textContent,
        }));
      }
        ...
        const s = () => {
          const [n, i] = D(this.getConfig()),
            ...
            V = () => (
              _(),
              this.getItems()
                .filter((a) => a.text.toLowerCase().includes(E().toLowerCase()))
                .filter((a) =>
                  l()
                    ? !L()
                        .map((d) => d.value)
          ...
          function je(a, d) {
            let o =
              d === "ArrowUp" ? a.previousElementSibling : a.nextElementSibling;
            for (; o && Ue(o); )
              o =
                d === "ArrowUp"
          ...
          const Me = () => {
            this.addOption(E(), E(), !0, n().createPosition), w(""), l() || H();
          };
          ...
          const Ct = ({ children: a }) =>
            ...
            $t = ({ children: a }) =>
              (() => {
                ...
                return (
                  (d.$$mousedown = (o) => {
                    !h() && o.target.getAttribute("role") !== "button" && St(),
                      C.focus();
                  }),
                  $(d, a),
                  T(
                    (o) => {
                      ...
                      return (
                        f !== o.e && Te(d, (o.e = f)),
                        p !== o.t && d.classList.toggle("focus", (o.t = p)),
                        v !== o.a && d.classList.toggle("disabled", (o.a = v)),
                        o
                      );
                    },
            ...
            It = () =>
              U(() => {
                ...
                return U(() => {
                  var d;
                  return ((d = L()[0]) == null ? void 0 : d.value) === "";
                })()
                  ? ""
                  : (a = L()[0]) == null
                  ? void 0
                  ...
                  (() => {
                    ...
                    return (
                      ...
                      $(
                        ...
                        m(q, {
                          ...
                          get children() {
                            ...
                            return (
                              (f.$$click = (p) => {
                                p.stopPropagation(), a.removeValue(d.value);
                              }),
                              $(f, m(Be, {})),
                              f
                            );
                      ...
                      T(
                        (f) => {
                          var p = !!h(),
                            v = !!r().includes("form-select-sm"),
                            x = !!r().includes("form-select-lg");
                          return (
                            p !== f.e &&
                              o.classList.toggle("disabled", (f.e = p)),
                            v !== f.t &&
                              o.classList.toggle("btn-sm", (f.t = v)),
                            x !== f.a &&
                              o.classList.toggle("btn-lg", (f.a = x)),
                            f
                          );
                        },
                        { e: void 0, t: void 0, a: void 0 }
            ...
            kt = () => {
              ...
              return (() => {
                ...
                $(o, () => E() || "i"),
                  ...
                  (f.$$keydown = (v) => {
                    switch (v.key) {
                      case "Enter":
                        if (j()) {
                          const x = S.querySelector(".dropdown-item.active");
                          if (x) {
                            const M = x.dataset.value;
                            l() ? a.addValue(M) : (a.setValue(M), w(""), H());
                          } else n().creatable && Me();
                        } else W();
                        v.preventDefault();
                        break;
                      case " ":
                        n().searchable || (W(), v.preventDefault());
                        break;
                      case "Escape":
                        H();
                        break;
                      ...
                      case "Backspace":
                        if (n().searchable && E() === "")
                          if (l()) {
                            const x = L();
                            x.length > 0 &&
                              a.removeValue(x[x.length - 1].value);
                          } else a.clearValue();
                        break;
                    }
                  }),
                ...
                return (
                  ...
                  T(
                    (v) => {
                      var x = !!((n().searchable && P()) || K(L()).length < 1),
                        M = xt(),
                        Z = !n().searchable && !h(),
                        z = h();
                      return (
                        x !== v.e &&
                          d.classList.toggle("position-relative", (v.e = x)),
                        M !== v.t && Ie(f, "placeholder", (v.t = M)),
                        Z !== v.a && (f.readOnly = v.a = Z),
                        z !== v.o && (f.disabled = v.o = z),
                        v
                      );
                    },
              ...
              return m(q, {
                ...
                get children() {
                  ...
                  return (
                    ...
                    $(d, m(Be, {})),
                    T(() => d.classList.toggle("d-none", K(L()).length < 1)),
                    d
                  );
                },
              });
            ...
            Dt = ({ children: a }) =>
              (() => {
                var d = pe(),
                  o = S;
                return typeof o == "function" ? de(o, d) : (S = d), $(d, a), d;
              })(),
            Ot = ({ item: a }) => {
              const d = this;
              return (() => {
                ...
                return (
                  (o.$$click = () => {
                    l() ? d.addValue(a.value) : (d.setValue(a.value), H());
                  }),
                  (o.$$mouseover = (f) => {
                  ...
                  T(
                    (f) => {
                      var p = a.value,
                        ...
                        z = a.text;
                      return (
                        p !== f.e && Ie(o, "data-value", (f.e = p)),
                        v !== f.t &&
                          o.classList.toggle("optgroup-item", (f.t = v)),
                        x !== f.a && o.classList.toggle("disabled", (f.a = x)),
                        M !== f.o && o.classList.toggle("active", (f.o = M)),
                        Z !== f.i && o.classList.toggle("selected", (f.i = Z)),
                        z !== f.n && (o.innerHTML = f.n = z),
                        f
                      );
                    },
                    {
              ...
              (() => {
                ...
                return (
                    ...
                    m(q, {
                      ...
                      get children() {
                        ...
                        return (
                          ...
                          T(
                            () =>
                              (o.innerHTML = n().creatableText.replace(
                                "{value}",
                                E()
                              ))
                          ),
                  ...
                  $(
                    ...
                    m(q, {
                      get when() {
                        return U(() => !!n().searchable)() && V().length < 1;
                      },
                      get children() {
                        var o = gt();
                        return $(o, () => n().noResultsText), o;
                      },
                    }),
                    null
                  ),
                  T(
                    (o) => {
                      var f = !!j(),
                        p = n().maxHeight;
                      return (
                        f !== o.e && a.classList.toggle("show", (o.e = f)),
                        p !== o.t &&
                          ((o.t = p) != null
                            ? a.style.setProperty("max-height", p)
          ...
          return (
            Ge(() => {
              ...
              j() ||
                (w(""),
                me(),
                (a = S.querySelector(".dropdown-item.selected")) == null ||
