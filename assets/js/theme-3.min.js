...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateButtonVisibility() {
    ...
    if (!isMobile) {
      // Desktop view - hide both buttons
      closeButton.style.display = "none";
      toggleButton.style.display = "none";
    } else {
      // Mobile view - show/hide based on sidebar state
...
const theme = {
  ...
  headerNavbar: () => {
    document
      .querySelectorAll(".offcanvas.offcanvas-navbar")
      .forEach((offcanvasNavbar) => {
        let timeout;
        const dropdowns =
          offcanvasNavbar.querySelectorAll(".nav-item.dropdown");
        const toggleIcons = offcanvasNavbar.querySelectorAll(
        ...
        offcanvasNavbar.addEventListener("show.bs.offcanvas", () => {
          toggleIcons.forEach((icon) =>
            icon.classList.replace("hicon-thin-arrow-down", "hicon-plus-thin")
          );
        });
  ...
  aosAnimations: () => {
    AOS.init({ delay: 350, duration: 1000, once: !0, mirror: !0, offset: 50 });
  },
  splideSlider: () => {
    if (document.querySelector(".destination-slider")) {
      new Splide(".destination-slider", {
        ...
        focus: 0,
        breakpoints: {
          1400: { perPage: 3, padding: { left: 0, right: "180px" } },
          1200: {
            perPage: 1,
            padding: { left: 0, right: "280px" },
            arrows: !1,
          },
          992: { perPage: 1, padding: { left: 0, right: "250px" }, arrows: !1 },
          576: { perPage: 1, gap: "0.75rem", arrows: !1, padding: 0 },
        },
      }).mount();
    }
    if (document.querySelector(".tour-category-slider")) {
      new Splide(".tour-category-slider", {
        ...
        focus: 0,
        breakpoints: {
          1400: { perPage: 4, padding: { left: 0, right: "150px" } },
          1200: { perPage: 2, padding: { left: 0, right: "150px" } },
          992: { perPage: 2, padding: { left: 0, right: "120px" } },
          576: {
            perPage: 1,
    ...
    if (document.querySelector(".tour-slider-1")) {
      new Splide(".tour-slider-1", {
        ...
        breakpoints: {
          ...
          992: { perPage: 1, padding: { left: 0, right: "250px" }, arrows: !1 },
          576: { perPage: 1, gap: "2rem", arrows: !1, padding: 0 },
        },
      }).mount();
    }
    if (document.querySelector(".tour-slider-2")) {
      new Splide(".tour-slider-2", {
        ...
        breakpoints: {
          1400: { perPage: 3, padding: { left: 0, right: "180px" } },
          1200: { perPage: 1, padding: { left: 0, right: "280px" } },
          992: { perPage: 1, padding: { left: 0, right: "250px" } },
          576: { perPage: 1, gap: "0.75rem", arrows: !1, padding: 0 },
        },
      }).mount();
    }
    ...
    if (document.querySelector(".testimonials-slider-1")) {
      new Splide(".testimonials-slider-1", {
        ...
        breakpoints: {
          1400: { perPage: 2 },
          1200: { perPage: 1, arrows: !1 },
          992: { perPage: 1, arrows: !1 },
          576: { perPage: 1, gap: "0.75rem", arrows: !1 },
        },
      }).mount();
    }
    if (document.querySelector(".testimonials-slider-2")) {
      new Splide(".testimonials-slider-2", {
        ...
        breakpoints: {
          1400: { perPage: 1 },
          1200: { perPage: 1, arrows: !1, pagination: !0 },
          992: { perPage: 1, arrows: !1, pagination: !0 },
          576: { perPage: 1, gap: "0.75rem", arrows: !1, pagination: !0 },
        },
      }).mount();
    }
  ...
  gLightbox: () => {
    let photoLightbox = GLightbox({ selector: ".glightbox" });
  ...
  dropdownSelect: () => {
    ...
    dropdownSelects.forEach((element) => {
      new UseBootstrapSelect(element, { maxHeight: "15.35rem" });
    });
  },
  bsValidation: () => {
...
function handlePageLoad() {
  document.addEventListener("DOMContentLoaded", function () {
    const skeleton = document.getElementById("preloader");
    ...
    function showContent() {
      if (skeleton && content) {
        ...
        console.error("Error: 'preloader' or 'body' element not found!");
      }
    }
