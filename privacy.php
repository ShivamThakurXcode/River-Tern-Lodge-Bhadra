...
<head>
    ...
    <meta name="description"
        content="Learn about the privacy policy of Rivertern Lodge Bhadra, a tranquil retreat in Karnataka's Chikmagalur district.">
    <meta name="keywords"
        content="Rivertern Lodge Bhadra, Privacy Policy, Karnataka, Chikmagalur, Eco-Lodge, Nature Retreat, Adventure, Wildlife Sanctuary">
...
">book@riverternlodge.com
                                    ...
                                    <li> <i class="hicon hicon-telephone "></i>
                                        <a class="px-3" href="tel:+9480022108">+91-9480022108</a>
                                    </li>
                                    <li> <i class="hicon hicon-map-entry"></i>
                                        <a class="px-3 text-black">Rivertern Lodge Bhadra,
                                            Behind Ranganathaswamy
                                            Temple, Tarikere, Lakkavalli,
                                            Karnataka 577115</a>
                                    </li>
                    ...
                    <div class="col-12 col-xl-3 col-md-6">
                        <div class="footer-widget">
                            ...
                            <div class="footer-local">
                                ...
                                <div class="col-10">
                                    <p class="text-white">Rivertern Lodge Bhadra,
                                        <br>
